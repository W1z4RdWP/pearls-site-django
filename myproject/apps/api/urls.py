...
urlpatterns = [
    ...
    path('builder/update_control/', builder_views.api_lesson_update_control, name='api_builder_update_control'),
    ...
    path('courses/course/<slug:slug>/assign-to-expert/', courses_views.api_assign_course_to_expert, name='api_courses_assign_to_expert'),
    path('courses/course/<slug:slug>/assign-to-assigned/', courses_views.api_assign_course_to_assigned, name='api_courses_assign_to_assigned'),
    ...
    path('courses/course/<slug:course_slug>/lesson/<int:lesson_id>/', courses_views.api_lesson_detail, name='api_courses_lesson_detail'),
    path('courses/course/<slug:course_slug>/lesson/<int:lesson_id>/complete/', courses_views.api_complete_lesson, name='api_courses_complete_lesson'),
    path('courses/lesson/<int:lesson_id>/delete/', courses_views.api_delete_lesson, name='api_courses_delete_lesson'),
